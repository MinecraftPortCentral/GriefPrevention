...
public class CommandUnseparate implements CommandExecutor {
    ...
    public CommandResult execute(CommandSource src, CommandContext args) {
        ...
        GriefPrevention.instance.setIgnoreStatus(targetPlayer, targetPlayer2, IgnoreMode.None);
        GriefPrevention.instance.setIgnoreStatus(targetPlayer2, targetPlayer, IgnoreMode.None);
