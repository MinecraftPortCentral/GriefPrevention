...
public class CommandHelp implements CommandExecutor {
    ...
    public CommandResult execute(CommandSource src, CommandContext ctx) {
        HashMap<List<String>, CommandSpec> gpSubcommands = GriefPrevention.instance.registerSubCommands();
        ...
        PaginationBuilder paginationBuilder = paginationService.builder().title(Text.of(TextColors.AQUA, "Showing GriefPrevention Help")).paddingString("-").contents(helpList);
